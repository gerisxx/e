...
local SyrexLib = {
  ...
  Elements = {},
  Configs = {
    ["Color Hub 1"] = Color3.fromRGB(26, 26, 28),
    ["Color Hub 2"] = Color3.fromRGB(32, 32, 38),
    ["Color Theme"] = Color3.fromRGB(247, 249, 250),
...
SyrexLib.Icons = HttpService:JSONDecode(game:HttpGetAsync(GitHub .. "evoincorp/lucideblox/master/src/modules/util/icons.json")).icons

local ConfigsHub = SyrexLib.Configs
local ElementsHub = SyrexLib.Elements
...
function SyrexLib.Elements:Stroke(parent, props)
...
function SyrexLib.Elements:Corner(parent, props)
...
function SyrexLib.Elements:Button(parent, Size, props)
...
function SyrexLib.Elements:Text(parent, props)
...
function SyrexLib:GetIcon(IconName)
  return SyrexLib.Icons[IconName]
end

function SyrexLib:Destroy()
  ScreenGui:Destroy()
end

function SyrexLib:Visible(Bool)
  ScreenGui.Enabled = Bool
end

function SyrexLib:Set(val1)
...
function SyrexLib:MakeNotify(Configs)
  local NName = Configs[1] or Configs.Name or "Syrex Library"
...
function SyrexLib:MakeWindow(Configs)
  ...
  local HubTitle = Menu[1] or Menu.Title or "SyrexHub Library"
  
  local Animation = Configs[2] or Configs.Animation or {}
  local AnimationText = Animation[1] or Animation.Text or ".gg/syrexhub"
  ...
  function Window:MakeTab(Configs)
    local TabName = Configs[1] or Configs.Name or "Syrex Library"
